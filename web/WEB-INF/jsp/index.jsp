<%-- 
    Document   : success
    Created on : Jan 26, 2018, 8:15:13 PM
    Author     : Phuong Duy
--%>
...
<html lang="en">
    ...
    <body>
                ...
                <div class="row" id="pwd-container">
                    ...
                    <div class="col-md-4">
                        <section class="login-form">
                            <form method="post" action="index.htm" method="post" role="login">

                                <input type="text" name="name" placeholder="Username" required class="form-control input-lg" />

                                <input type="password" name="mark" class="form-control input-lg" id="password" placeholder="Password" required="" />
        ...
        <section class="video">
            ...
            <a href="https://www.youtube.com/watch?v=PvA1kBKDmLo" id="play_btn" class="fancybox animated wow flipInX" data-wow-duration="2s"></a>
        </section><!--  End video  -->
        ...
        <footer>
            <div class="wrapper">
                <div class="rights">
                    ...
                    <p>© Sublime. All Rights Reserved 2014 -<a href="http://pixelhint.com" target="_blank">by Phuong Duy</a></p>
                </div>
